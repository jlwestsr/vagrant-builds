...
# Puppet Labs does not correctly set the password for the vagrant profile. We have to change the password to documented
# correct version
vagrant:~$ sudo su
...
vagrant:~$ sudo yum -y install git vim wget zsh
